...
class UverTest extends TestCase
{
    ...
    public function testCrearYRegistrarUsuarioPasajero()
    {
        $user = [
            'cedula' => '504390996',
            'numero' => 63549134,
   ...
   public function testCrearUsuarioDuplicadoPasajero()
    {
        // Crear un usuario inicial
        $usuario = Usuario::create([
            'cedula' => '1234567890',
        ...
        $response = $this->postJson('/api/crear-registrar-usuario-pasajero', $user2);
